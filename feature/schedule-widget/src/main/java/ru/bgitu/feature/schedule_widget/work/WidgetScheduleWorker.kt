...
class WidgetScheduleWorker(
    ...
    companion object {
        private val scheduleWorkName = WidgetScheduleWorker::class.simpleName!!
        ...
        fun start(context: Context, queryDate: LocalDate) {
            val request = OneTimeWorkRequestBuilder<WidgetScheduleWorker>()
