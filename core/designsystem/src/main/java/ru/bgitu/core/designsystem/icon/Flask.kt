...
val AppIcons.Flask: ImageVector
    get() {
        if (_Flask != null) {
            return _Flask!!
        }
        _Flask = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveToRelative(0f, 0.694f, -0.29f, 1.36f, -0.795f, 1.827f)
                curveTo(3.374f, 12.131f, 0f, 15.984f, 0f, 19.5f)
                curveToRelative(0f, 0.852f, 0.211f, 1.641f, 0.629f, 2.347f)
                curveToRelative(0.789f, 1.328f, 2.307f, 2.153f, 3.961f, 2.153f)
                horizontalLineToRelative(14.82f)
                curveToRelative(1.654f, 0f, 3.172f, -0.825f, 3.962f, -2.155f)
                curveToRelative(0.417f, -0.704f, 0.628f, -1.493f, 0.628f, -2.345f)
                curveToRelative(0f, -3.516f, -3.374f, -7.369f, -6.204f, -9.982f)
                close()
                moveTo(20.791f, 20.315f)
                curveToRelative(-0.247f, 0.417f, -0.789f, 0.686f, -1.381f, 0.686f)
                lineTo(4.59f, 21.001f)
                curveToRelative(-0.592f, 0f, -1.134f, -0.269f, -1.38f, -0.684f)
                curveToRelative(-0.142f, -0.238f, -0.21f, -0.505f, -0.21f, -0.816f)
                curveToRelative(0f, -0.697f, 0.281f, -1.548f, 0.809f, -2.5f)
                ...
                verticalLineToRelative(4.69f)
                curveToRelative(0f, 1.528f, 0.642f, 2.998f, 1.76f, 4.031f)
                curveToRelative(3.281f, 3.03f, 5.24f, 5.938f, 5.24f, 7.779f)
                curveToRelative(0f, 0.311f, -0.068f, 0.578f, -0.209f, 0.814f)
                close()
            }
        }.build()
